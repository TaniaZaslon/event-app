      ...
      <Container>
        <Row className="justify-content-center">
          <Col lg={6} className="text-center">
            ...
            <p className="mt-3 text-white-50">We will not spam at your inbox .Don't panic</p>            
          </Col>
        </Row>
        <Row>
          <Col lg={12} className="text-center mt-5">
            <p className="copy border-top pt-4 text-white-50 mb-0">Copyright Reserved to Themefisher. { new Date().getFullYear()}</p>
          </Col>
        </Row>
      </Container>
    </footer>
